...
export class FileService {
    ...
    public download(publicPath: IPublicPath) {
        ...
        link.href = `/api/files/download/${encodeURIComponent(publicPath.Id)}/${encodeURIComponent(publicPath.NextSegment)}`;
    ...
    public downloadPublicShare(publicShare: IShare) {
        const link = document.createElement('a');
        link.href = `/public-api/files/download/${publicShare.Id}`;
